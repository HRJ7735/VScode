...
//注意设置时STM32内部会右移一位对其! 0111 1111 1111 1111 1110=0X7FFFE			    
...
void WriteOneHzChar(uint16_t x,uint16_t y,uint8_t *font ,  uint16_t RGB_Code,uint16_t back_color);    //显示汉字
void LCD_ShowString(uint16_t x0, uint16_t y0,uint8_t *pcStr,  uint16_t RGB_Code,uint16_t back_color); //显示字符串
